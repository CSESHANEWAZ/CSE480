...
<body>
	...
	<a href="add_students.php" class="btn btn-primary"><i class="fa fa-plus" aria-hidden="true"></i> Add Students</a>
			...
			<div class="col-md-12">
				<div class="card">
					<div class="header">
						...
						<h4 class="title">List of the Students</h4>
						<p class="category"></p>
					</div>
					<div class="content table-responsive table-full-width">
						...
						$select_data = "SELECT * FROM students";       //attempt select query execution
