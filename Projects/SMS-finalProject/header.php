...
<html class="no-js"> 
	<head>
		...
		<title>
			<?php echo ucwords('School Management System'); ?> | <?php echo (isset($x -> TableTitle) ? $x -> TableTitle : ''); ?>
		</title>
		...
		<?php 
			...
			if(isset($x -> TableName) && is_file(dirname(__FILE__) . "/hooks/{$x -> TableName}-tv.js")){ 
				...
				?> <script src="<?php echo PREPEND_PATH; ?>hooks/<?php echo $x->TableName; ?>-tv.js"></script><?php 
			} 
		?>
	...
	<body class="body">
		<div class="container theme-cosmo theme-compact">
			...
			<?php if(!$_REQUEST['Embedded']){ ?>
				...
				<div style="height: 70px;" class="hidden-print"></div> <?php } 
			?>
